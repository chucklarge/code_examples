...
#    pygame.draw.circle(screen, white, (res_x_half, res_y_half), radius, 1)
    ...
    for i in range(num_objects):
      ...
      shapes_center.hexagon(screen, (0,60,0),   pos, r, 4)
      shapes_center.hexagon(screen, (0,255,0),   pos, r, 2)
...
if __name__ == '__main__':
  ...
  #main(resolution=(1440,900), fullscreen=True, num_objects=32, radius=320)
